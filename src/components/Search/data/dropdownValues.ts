//[TODO] pulled over from legacy globals file, should reall be in a DB

export const finalTypeLabelsLower = ["final",
    "final and rod",
    "second final",
    "revised final",
    "final revised",
...
export const draftTypeLabelsLower = ["draft",
    "second draft",
    "revised draft",
    "draft revised",
    "draft supplement",
